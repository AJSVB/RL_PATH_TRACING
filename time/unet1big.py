...
class UN(TorchModelV2, nn.Module):
    def __init__(
        ...
        in_channels=4
        self._convs = UNet( temp,in_channels,
        (in_channels, in_channels * 2, in_channels * 4, in_channels * 8),
         (in_channels * 8, in_channels * 4, in_channels * 2)
        )
        c = 3
...
ModelCatalog.register_custom_model("UNbig", UN)
